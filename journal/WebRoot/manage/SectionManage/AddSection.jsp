...
<script type="text/javascript" src="<%=SiteConfig.DoMain %>scripts/manage-SectionManage-AddSection.js"></script>
</head>
<body>
		...
		<div class="row-fluid">
			<div class="span12">
				<table class="table table-bordered table-striped">
				    <tr>
				    <td colspan="2" style="text-align:center;line-height:29px;font-size:16px;font-weight:bold">新建阶段</td>
				    </tr>
					<tr>
						...
						<td class="span8">
						<div class="controls">
					      <input name="sectionName"  style="width:97%;" type="text" placeholder="请填写阶段名称" form-val="empty" class="input-xlarge" maxlength="20" />

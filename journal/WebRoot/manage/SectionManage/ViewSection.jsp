		...
		<div class="row-fluid">
			<div class="span12">
				<table class="table table-bordered table-striped">
				    <tr>
				    	<td colspan="2" style="text-align:center;line-height:29px;font-size:16px;font-weight:bold">查看阶段</td>
				    </tr>
					<tr>
						...
						<td class="span8">
						<div class="controls">
					      <input value="${sectionInfo.name}" name="sectionName" style="width:97%;" type="text" class="input-xlarge" maxlength="20" readonly/>
				        </div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="controls">
								<textarea name="remark"
									style="margin: 0px; height: 104px; width: 97%;resize:none;" readonly>${sectionInfo.remark}</textarea>
							</div></td>
					</tr>
				</table>
			</div>

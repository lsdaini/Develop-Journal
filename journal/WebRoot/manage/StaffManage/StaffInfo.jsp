	...
	<input type="hidden" name="method" value="completeStaffInfo"/>
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="idCard" value="${staffInfo.idCard}" msg-ctrl-id="idcard-error" form-val="idcard" val-idcard-msg="身份证号格式不正确!"  placeholder="请填写您的身份证号码" class="input-xlarge" maxlength="18" />
					<div id="idcard-error" class="input-error-info"></div>
				</div>
			</div>
			<div class="control-group">

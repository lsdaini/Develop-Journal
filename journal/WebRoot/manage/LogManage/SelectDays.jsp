...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
				<form id="getLogsByDate"
					action="<%=SiteConfig.DoMain%>actions/log/logActions.action?method=getLogsByDate"
					method="post" class="form-horizontal">
					<input type="hidden" id="hidSelectDate" name="selectDate" value="" />
					<input type="hidden" id="hidReportedData" value='${reportedData}' />
					<div class="container-fluid">
						<div class="row-fluid">
							<div class="span12">
								<div class="row-fluid">
									<div class="span12">
										<div class="row-fluid">
											<div class="span1" style="width:40px">
												<button id="btnMyReports" class="btn" type="button"
													title="我的汇报">

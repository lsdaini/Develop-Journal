...
;(function($, undefined) {
	...
	function Confirm(options) {
		...
		if (!$modal.length) {
			$modal = $('<div class="modal" id="' + this.options.target.substr(1) + '"><div class="modal-body inner"/><div class="modal-footer"><a href="#" class="btn btn-danger" data-action="1">'+this.options.buttonText.left+'</a> <a class="btn cancel" href="#" data-dismiss="modal">'+this.options.buttonText.right+'</a></div></div>').appendTo(this.options.appendTo).hide();
	...
	$.fn[pluginName].defaults = {
		...
		,buttonText:{"left":"OK","right":"Cancel"}
	};
